...
public static void SelectionSort(int [] vetorSelectionSort){
    ...
    for(int i = 0; i < vetorSelectionSort.length - 1; i++)
    {
        ...
        for(int j = i + 1; j < vetorSelectionSort.length + 1; j++)
        {
...
//======================================================================
    ...
    public static void InsertionSort(int [] vetorInsertionSort){
        ...
        {
            temp = vetorInsertionSort[i];
            j = i - 1;
            while(j >= 0 && vetorInsertionSort[j] > temp)
            {
                vetorInsertionSort[j + 1] = vetorInsertionSort[j];
                j--;
            }
            vetorInsertionSort[j + 1] = temp;
        }
    }
//======================================================================
    ...
    public static void BubbleSort(int [] vetorBubbleSort){
        ...
        {
            for(int j = i; j < vetorBubbleSort.length - i - 1; j++)
            {
...
//======================================================================
    ...
    public static void ShellSort(int [] vetorShellSort){
    int inner, outer, temp;
    int intervalo = 1;

    while(intervalo <= vetorShellSort.length / 3){
        intervalo = intervalo * 3 + 1;
        while (intervalo > 0) {
            for(outer = intervalo; outer < vetorShellSort.length; outer++)
            {
                temp = vetorShellSort[outer];
                inner = outer;
                while(inner > intervalo - 1 && vetorShellSort[inner - intervalo] >= temp)
            }
        }
    }
}
...
public static void MergeSort(int [] vetorMergeSort){
